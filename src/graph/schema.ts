...
export const schemaStatements = [
  ...
  "CREATE NODE TABLE IF NOT EXISTS Import(id STRING PRIMARY KEY, source STRING, specifier STRING, line INT64, isReExport BOOLEAN, isWildcard BOOLEAN, isDynamic BOOLEAN, bindings STRING)",
